...
class Agent(ABC):
    ...
    def complete(self) -> bool:
        """
        Indicates where the current instruction execution is complete.
    ...
    def step(self, state: 'State') -> 'Action':
        """
        Starts the execution of assigned instruction. This method should be
        implemented by subclasses to define the specific execution logic.
        """
        pass
    ...
    def reset(self) -> None:
        """
        Reset the agent execution status and clears the history. This method can be used
    ...
    def register(cls, name:str, agent_cls:Type['Agent']):
        """
        Register and agent class in the registry.
    ...
    @classmethod
    def get_clas(cls, name:str) -> Type['Agent']:
        """
