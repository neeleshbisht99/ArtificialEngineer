...
class LLM:
    ...
    def __init__(self,
        ...
        Args:
            ...
            num_retries (int, optional): The number of retires for API calss. Defaults to LLM_NUM_RETRIES.
            retry_min_wait (int, optional): The minimum time to wait between retries in seconds. Defaults to LLM_RETRY_MIN_WAIT.
            retry_max_wait (int, optional): The maximum time to wait between retries in seconds. Defaults to LLM_RETRY_MAX_WAIT.
        ...
        logger.info(f'Initializing LLM with mode: {model}')
