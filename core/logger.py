...
def log_uncaught_exceptions(ex_cls, ex, tb):
    ...
    Agrs: 
        ...
        ex(Eception): The exceptions instance.
        eb(traceback): THe traceback object.
...
class LlmFileHandler(logging.FileHandler):
    ...
    def __init__(self, filename, mode='a', encoding='utf-8', delay=False):
        """
        Initializes and instance of LlmFileHandler.
...
llm_prompt_logger.setL(logging.DEBUG)
llm_prompt_logger.addHandler(get_llm_prompt_file_handler())

llm_response_logger= logging.getLogger('prompt')
llm_response_logger.propagate = False 
llm_response_logger.setL(logging.DEBUG)
