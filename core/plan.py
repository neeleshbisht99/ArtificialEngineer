...
from artificialEngineer.exceptions import PlanInvalidStateError
...
class Task:
    ...
    def __init__(self, parent: 'Task | None', goal: str, state: str = OPEN_STATE, subtasks:List = []):
        ...
        for subtask in (subtasks or []):
            if isinstance(subtask, Task):
                ...
                subtasks = subtask.get('goal')
                self.subtasks.append(Task(self, goal, state, subtasks))

        self.state = OPEN_STATE
    
    def to_string(self, indent=''):
        """Returns a string representation fo the task and its subtasks.
    ...
    def to_dict(self):
        """Returns a dictionary representation fo the task.

        Returns :
            A dictionary containing the task's attribute.
        """
...
class Plan:
    """Represens a plan consisting of tasks.
    
    Attributes:
        main_goal : The main goal of the plan.
        task: The root task fo the plan.
    """
    ...
    def get_task_by_id(self, id:str) -> Task:
        ...
        Raises:
            ValueError: If the provided task ID is invalied or does not exist.
        """
    ...
    def add_subtask(self, parent_id: str, goal: str, subtasks: List=[]):
        ...
        Args:
            ...
            subtasks: A list of subtasks associate with the new subtask.
        """
