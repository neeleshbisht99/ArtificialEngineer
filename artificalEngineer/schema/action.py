...
class ActionTypeSchema(BaseModel):
    ...
    """
    Start a new development task. Only sent by the client.
    """
    ...
    BROWSE: str = Field(default='browser')
    """
    Opens a web page
    """
    ...
    """
    If you are absolutely certain that you have completed your task and have tested your work,
