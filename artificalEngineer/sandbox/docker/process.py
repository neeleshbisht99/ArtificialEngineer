...
class DockerProcess(Process):
    """
    Represents a background command in execution/
    """
    ...
    def read_logs(self) -> str:
        ...
        This function continously read the standard output of a subprocess and
        processes the output using the parse_socker_exec_output function to handle 
        binary log messages. It concatenates and decodes the ouput bytes into a 
